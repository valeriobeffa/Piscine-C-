...
ClapTrap::ClapTrap() : _Hitpoint(10), _Energy_points(100), _Attack_damage(30)
{
    std::cout << "CT Default constructor called" << std::endl;
    this->_name = "Gino";   
}

ClapTrap::ClapTrap(std::string name) : _Hitpoint(100), _Energy_points(50), _Attack_damage(20)
{
